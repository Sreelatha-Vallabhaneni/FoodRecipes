    ...
    <View className="mx-4">
        ...
        <View>
            ...
            <View className="flex flex-row justify-between mt-3 mb-8 ">
                ...
                <TouchableOpacity 
                    className="bg-orange text-blackBrown w-1/2 font-bold flex justify-center items-center rounded-xl"
                    onPress={() => navigation.navigate('Recipe', { recipeId: data.meals[0].idMeal })}
                    >
